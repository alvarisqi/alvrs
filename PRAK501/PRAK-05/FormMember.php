        ...
        <?php if (empty($id_member)) : ?>
            <section>
                ...
                <form action="" method="post">
                    ...
                    <div class="center">
                        <button class="waves-effect waves-light blue btn-small" type="submit" name="submit">Submit</button>
            ...
            <?php $member = getData("member WHERE id_member = $id_member")[0];?>    
                ...
                <div class="center">
                    <button class="waves-effect waves-light blue btn-small" type="submit" name="ubah">Ubah</button>
                    <a href="Member.php" class="waves-effect waves-light green btn-small">Kembali</a>
                </div>
            </form>
        </section>
